...
class ExportServiceTest {
    ...
    void shouldGenerateUniqueNameWhenFilesShareSameName() throws IOException {
        ...
        PhotoItem firstItem = new PhotoItem(firstSource, "Photo", LocalDate.of(2024, 1, 10), "1KB", List.of(), List.of(), false);
        PhotoItem secondItem = new PhotoItem(secondSource, "Photo", LocalDate.of(2024, 1, 11), "1KB", List.of(), List.of(), false);

...
public class GalleryView {
    ...
    private void launchImport(Window owner) {
        ...
        Task<List<Photo>> scanTask = new Task<>() {
            @Override
        ...
        scanTask.setOnSucceeded(event -> {
            ...
            renderPhotos(photos);
            statusLabel.setText(photos.isEmpty() ? "Aucune photo trouvee" : photos.size() + " photos chargees");
            progressIndicator.setVisible(false);
        });
        scanTask.setOnFailed(event -> {
            ...
            showError("Import echoue", "Le dossier n'a pas pu etre scanne. Verifiez le disque et reessayez.");
        });
